...
contract CarNFT_Generate is KIP17, KIP17URIStorage, Ownable {
    ...
    */
    ...
    // 엔카, 크기: 약50kb, 사이즈: 1100*619
    string private _defaultImageURI = "https://gateway.pinata.cloud/ipfs/QmacnV7iSpZkpvzbR3orPBPpmeX9CCzsURAaxLLZMKWktY";
    string private _Avante = "https://gateway.pinata.cloud/ipfs/QmbgzkikJs4qpsFnw2g8Wf8Z7tjCQBkjqV4Vmes8FPsZsu?filename=Avante.png";
    string private _Carnival = "https://gateway.pinata.cloud/ipfs/QmSkAYbkgAQhyxZPmNzgnHMCYygABhDar6DHJJY3bDnQ5q?filename=Carnival.png";
    string private _G90 = "https://gateway.pinata.cloud/ipfs/QmVJLUFG6weeoy6iNx8MbGQbUur5U1VxaTKoigmxDQDvSg?filename=G90.png";
    string private _Grandeur = "https://gateway.pinata.cloud/ipfs/QmNjC8LCfMaCzmcRsrLgBVWaZpZHWSJaGBK5bn56Jq5A4G?filename=Grandeur.png";
    string private _K5 = "https://gateway.pinata.cloud/ipfs/QmcKwSdePLD5Tbt6T62bd9Wkrwe1mcoUzzSZkkfdv8cuvV?filename=K5.png";
    string private _K7 = "https://gateway.pinata.cloud/ipfs/QmZn4m5N5vv31e23FNJQXhaKny3dtyvVx1Xgacv7pGJekD?filename=K7.png";
    string private _Matiz = "https://gateway.pinata.cloud/ipfs/QmWyZwrknY6GhbQ7d7nXSXAE9bxijHtK4SFNMgWhG1H4HS?filename=Matiz.png";
    string private _Morning = "https://gateway.pinata.cloud/ipfs/QmQMr7bYHs1FsSRDruBEAUZ3Vc3rpQaN7BfFGzqMDJZg3G?filename=Morning.png";
    string private _Rexton = "https://gateway.pinata.cloud/ipfs/QmSZpiBrzLJBUEoaLvr59mQCFor6byiFkjKPKK7W71e5kK?filename=Rexton.png";
    string private _SM5 = "https://gateway.pinata.cloud/ipfs/QmNVLRqpMYxM9ArxJUSUbpMDXFGYXLRDhomNWP6NsHfTDP?filename=SM5.png";
    string private _Santafe = "https://gateway.pinata.cloud/ipfs/QmbrBg9fms4xqAhEg8UXeawFuHr3q34TEuUeCQ1xdhRD1S?filename=Santafe.png";
    string private _Sonata = "https://gateway.pinata.cloud/ipfs/Qmf9CqnuXxVcyJycXhNFhFHHnLMYHojzpmb4LNnwTYtnxk?filename=Sonata.png";
    string private _Sorento = "https://gateway.pinata.cloud/ipfs/QmaJ1dc8rZEWUS99x7CmCUyrNUysiTYZA5oJQYMteWbWyR?filename=Sorento.png";
    ...
    */
    function getTokenImageURI(uint256 tokenId) private view returns (string memory) {
        ...
        if (compareModel(model, "Avante")) {
            return _Avante;
        } else if (compareModel(model, "Carnival")) {
            return _Carnival;
        } else if (compareModel(model, "G90")) {
            return _G90;
        } else if (compareModel(model, "Grandeur")) {
            return _Grandeur;
        } else if (compareModel(model, "K5")) {
            return _K5;
        } else if (compareModel(model, "K7")) {
            return _K7;
        } else if (compareModel(model, "Matiz")) {
            return _Matiz;
        } else if (compareModel(model, "Morning")) {
            return _Morning;
        } else if (compareModel(model, "Rexton")) {
            return _Rexton;
        } else if (compareModel(model, "SM5")) {
            return _SM5;
        } else if (compareModel(model, "Santafe")) {
            return _Santafe;
